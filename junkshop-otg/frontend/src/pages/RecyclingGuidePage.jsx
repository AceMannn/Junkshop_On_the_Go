...
export default function RecyclingGuidePage() {
  ...
  return (
    <div className="pt-20 min-h-screen bg-light-gray">
      {/* Hero */}
      <section className="bg-gradient-to-br from-leaf-green to-eco-green text-white py-12">
            ...
            {steps.map((step, index) => (
              ...
              >
                <div className="flex-shrink-0">
                  <div className={`${step.color} w-16 h-16 rounded-full flex items-center justify-center text-white text-xl font-bold shadow-lg`}>
                    {step.number}
                  </div>
                </div>
                ...
                <Card className="flex-1 shadow-lg" hover={false}>
                  <div className="flex items-start gap-4">
                    <motion.div
                      className={`${step.color} p-3 rounded-[12px]`}
