...
export function FindJunkshopPage() {
    ...
    // Filtering junkshops by search and filter
    const filteredShops = junkshops.filter(shop => {
        ...
        const matchesFilter =
            selectedFilter === 'all' ||
            (selectedFilter === 'open' ? shop.status === 'Open' : shop.materials.includes(selectedFilter.charAt(0).toUpperCase() + selectedFilter.slice(1)));
