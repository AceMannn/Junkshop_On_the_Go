...
import { Search, DollarSign, MapPin, Leaf, Recycle, Package, Smartphone, ShoppingBag } from 'lucide-react';
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {howItWorks.map((step, index) => (
              <Card key={index} delay={index * 0.1}>
                <motion.div
                  className={`${step.color} w-14 h-14 rounded-full flex items-center justify-center mb-4`}
            ...
            {recyclables.map((item, index) => (
              <Card key={index} delay={index * 0.1}>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <item.icon className="text-eco-green" size={28} />
                </div>
              </Card>
            ))}
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                {[
                  ...
                  >
                    ...
                    <span className={`px-3 py-1 rounded-full text-sm ${
                      shop.status === 'Open' ? 'bg-eco-green text-white' : 'bg-gray-300 text-gray-600'
                    }`}>
                      {shop.status}
                    </span>
                  </motion.div>
            ...
            <motion.div
              className="relative h-[450px] bg-light-gray rounded-[24px] overflow-hidden"
              initial={{ opacity: 0, x: 50 }}
              whileInView={{ opacity: 1, x: 0 }}
              viewport={{ once: true }}
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <MapPin className="text-eco-green mx-auto mb-4" size={56} />
